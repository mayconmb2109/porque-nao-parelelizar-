...
public class Movimento implements Serializable {
    ...
    public Movimento(Integer idCompra, int quantidade, BigDecimal precoUnitario, Date dataMovimento, Character tipo) {
        this.idCompra = idCompra;
    ...
    public String toString() {
        return "cadastroserver.model.Movimento[ idCompra=" + idCompra + " ]";
    }
